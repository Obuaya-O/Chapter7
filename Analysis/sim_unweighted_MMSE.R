#!/usr/bin/env Rscript
# PURPOSE: Executes the Monte Carlo simulation to evaluate the Unweighted Biomarker Panel using MMSE as the primary clinical endpoint 
...
print(paste("Unweighted MMSE Scen:", job_id, "| N:", scen$sample_size))
...
dir.create("results_unweighted_MMSE", showWarnings=F)
saveRDS(results, paste0("results_unweighted_MMSE/job_", job_id, "_chunk_", chunk_id, ".rds"))